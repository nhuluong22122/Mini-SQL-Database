...
/* Table packed descriptor list = 4+4+4+36 = 48 bytes.  When no
   ...
   This can be view view list ____
*/
...
/* This token_list definition is used for breaking the command
   string into separate tokens in function get_tokens().  For
	 ...
	 together.
   Can be viewed via list schema for ____
 */
...
/* This table_file_header definition is used to create tab files
...
typedef enum error_return_codes
{
  ...
  /* Must add all the possible errors from I/U/D + SELECT here */
	...
	/* COMMON ERROR FOR SOME SELECTION */
	NOT_NULL_EXCEPTION = -380,
	INVALID_DATA_VALUE,
	DATATYPE_MISMATCH,
	INVALID_RELATIONAL_OPERATOR,
	INVALID_AGGREGATE_FUNCTION_PARAM,
	/* INSERT ERROR */
	INSERT_SYNTAX_VALUE = -199,
	/* DELETE ERROR */
  INVALID_DELETE_SYNTAX = -370,
	/* UPDATE ERROR */
